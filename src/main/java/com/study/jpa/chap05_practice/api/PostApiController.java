...
@Tag(name = "post API", description = "게시물 등록및 삭제 api입니다")
@RestController
@Slf4j
...
@Operation(summary = "게시물 등록", description = "게시물 작성 및 등록을 담당하는 메서드")
   @Parameters({
    ...
    @Operation(summary = "게시글 수정",description = "게시물 수정을 담당하는 메서드")
    @ApiResponses(value = {
 ...
 log.info("pots{} - payload {}", request.getMethod(),dto);
